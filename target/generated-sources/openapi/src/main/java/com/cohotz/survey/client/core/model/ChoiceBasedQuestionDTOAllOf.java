...
/**
 * ChoiceBasedQuestionDTOAllOf
 */
@JsonPropertyOrder({
  ChoiceBasedQuestionDTOAllOf.JSON_PROPERTY_RESPONSE_OPTIONS
})
@JsonTypeName("ChoiceBasedQuestionDTO_allOf")
...
public class ChoiceBasedQuestionDTOAllOf {
  ...
  public ChoiceBasedQuestionDTOAllOf() { 
  }

  public ChoiceBasedQuestionDTOAllOf responseOptions(List<ResponseOption> responseOptions) {
    
    this.responseOptions = responseOptions;
    return this;
  }

  public ChoiceBasedQuestionDTOAllOf addResponseOptionsItem(ResponseOption responseOptionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChoiceBasedQuestionDTOAllOf choiceBasedQuestionDTOAllOf = (ChoiceBasedQuestionDTOAllOf) o;
    return Objects.equals(this.responseOptions, choiceBasedQuestionDTOAllOf.responseOptions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(responseOptions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChoiceBasedQuestionDTOAllOf {\n");
